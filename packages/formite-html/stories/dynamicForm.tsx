...
import { FormiteHtmlForm, useForm, useInput } from "../src"; // "formite-html"
...
const FriendForm = (props: { form: FormiteHtmlForm<SampleType>; friend: Fields<FriendType> }) => {
    const { friend, form } = props;
    return (
        <div className="pure-g">
            <div className="pure-u">
                <label>First name</label>
                <input type="text" className="pure-u" {...useInput(form, friend.firstName, required)} />
            ...
            <div className="pure-u">
                ...
                <input type="text" className="pure-u" {...useInput(form, friend.lastName, required)} />
                <span className="pure-form-message">
...
const DynamicForm = () => {
    ...
    const { canSubmit, Form, fields, isDirty, reset, updateFields } = form;
    ...
    return (
        <Form className="pure-form pure-form-stacked">
            {fields.friends.map((friend, index) => (
                <FriendForm key={index} form={form} friend={friend} />
            ))}
